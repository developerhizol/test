...
# В aiogram 3 нужно правильно регистрировать хендлеры с FSM
...
# Регистрируем хендлер вручную с фильтром состояния
dp.message.register(handle_admin_message_to_user, TicketStates.WAITING_FOR_RESPONSE_TO_USER)
...
# Регистрируем хендлер для feedback тоже вручную
...
dp.message.register(handle_feedback_comment, TicketStates.WAITING_FOR_FEEDBACK)
...
async def handle_unknown(message: Message):
    # Просто ничего не делаем с неизвестными сообщениями
    pass
